...
class GuruController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            ->paginate(10);
            return view('page.admin.guru.list', compact('collection'));
        }
        return view('page.admin.guru.main');
    }
    public function create()
    {
        return view('page.admin.guru.input', ['guru' => new Guru]);
    }
    ...
    {
        return view('page.admin.guru.input', compact('guru'));
    }
