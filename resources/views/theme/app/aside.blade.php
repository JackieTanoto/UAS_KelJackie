<div id="kt_aside" class="aside bg-primary" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
    ...
    <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-8" id="kt_aside_logo">
        <a href="index.html">
            <img alt="Logo" src="{{asset('img/logo.png')}}" class="h-55px" />
        </a>
    </div>
    <!--end::Logo-->
    <!--begin::Nav-->
        ...
        <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-6" data-kt-menu="true">
            <div class="menu-item py-2">
                ...
                if($role == "a"){
                    ...
                    $raport = route('admin.raport.index');
                }
                elseif($role == "g"){
                    $dashboard = route('guru.dashboard');
                    $schedule = route('guru.schedule.index');
                    $raport = route('guru.raport.index');
                }
                elseif($role == "s"){
                    $dashboard = route('siswa.dashboard');
                    $schedule = route('siswa.schedule.index');
                    $raport = route('siswa.raport.index');
                }
                @endphp
                <a href="{{$dashboard}}" class="menu-link {{request()->is('admin/dashboard') || request()->is('guru/dashboard') || request()->is('siswa/dashboard') ? 'active' : ''}} menu-center" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
                <span class="menu-link {{request()->is('admin/course') || request()->is('admin/room') ? 'active' : ''}} menu-center" title="Data Master" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon me-0">
                ...
                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{request()->is('admin/course') ? 'active' : ''}}" href="{{route('admin.course.index')}}">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
                ...
                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{request()->is('admin/guru') ? 'active' : ''}}" href="{{route('admin.guru.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div class="menu-item py-2">
                <a href="{{$raport}}" class="menu-link {{request()->is('admin/raport') || request()->is('admin/raport') || request()->is('admin/raport') ? 'active' : ''}} menu-center" title="Nilai" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon me-0">
            ...
            @elseif($role == "g")
            <div class="menu-item py-2">
                <a href="{{$schedule}}" class="menu-link {{request()->is('admin/schedule') || request()->is('guru/schedule') || request()->is('siswa/schedule') ? 'active' : ''}} menu-center" title="Jadwal" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon me-0">
            ...
            <div class="menu-item py-2">
                <a href="{{$raport}}" class="menu-link {{request()->is('admin/raport') || request()->is('guru/raport') || request()->is('siswa/raport') ? 'active' : ''}} menu-center" title="Nilai" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon me-0">
                        <i class="bi bi-card-checklist"></i>
                    </span>
                </a>
            ...
            <div class="menu-item py-2">
                <a href="{{route('guru.room.index')}}" class="menu-link {{request()->is('admin/room') || request()->is('guru/absensi') || request()->is('siswa/absensi') ? 'active' : ''}} menu-center" title="Daftar Kelas" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon me-0">
                        <i class="bi bi-card-checklist"></i>
                    </span>
                </a>
