<div class="card rounded-0 bgi-no-repeat bgi-position-x-end bgi-size-cover" style="background-color: #663259;background-size: auto 100%; background-image: url({{asset('keenthemes/media/misc/taieri.svg')}})">
    ...
    <div class="card-body container pt-10 pb-8">
        ...
        <ol class="breadcrumb text-muted fs-6 fw-bold">
            <li class="breadcrumb-item pe-3 text-white">Data Dosen</li>
                ...
                <form id="form_input">
                    <div class="row mb-7">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
                                <label for="nip" class="required form-label">NIDN</label>
                                <input type="text" name="nidn" id="nidn" class="form-control form-control-solid" placeholder="NIDN" value="{{$guru->nidn}}" />
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
